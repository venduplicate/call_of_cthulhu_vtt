...
import {
  InvestigatorSchema,
  InvestigatorConverter,
  InvestigatorFirestore,
...
export class InvestigatorFirestoreClass extends UserBase {
  ...
  async updateInvestigator(
    userId: string,
    investigatorData: InvestigatorFirestore
...
export const investigatorHandler = loggingUtilWrapper(
  new InvestigatorFirestoreClass()
);
